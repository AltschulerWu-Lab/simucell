classdef Subpopulation <handle
  ...
  methods
    ...
    function add_marker(obj,marker_name,marker_color)
      %   add_marker      - Add a new marker to the subpopulation
      %
      %   add_marker(subpop, marker_name,marker_color) creates a new
      %     property of name marker_name (a string), type Marker and color
      %     specified by marker_color (one of the colors enumerated in
      %     Colors) in the markers property in the Subpopulation subpop.
      %
    ...
    function add_cell_artifact(obj,operation)
      %   add_cell_artifact      - Add a new  cell level artifact operation

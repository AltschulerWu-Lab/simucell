function delimiters = getCellMembraneModelDelimiters( data )
%GETCELLMEMBRANEMODELDELIMITERS Helper function that returns the two compartment
%delimiter indexes of the cell membrane model.
...
for i=1:1:length( data )
    if strfind( data{i}, '<compartment name="cell' )
        delimiters = i;
    end
end
